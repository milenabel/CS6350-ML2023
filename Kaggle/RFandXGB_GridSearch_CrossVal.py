...
rf_cv_scores = cross_val_score(rf_model_best, X_train_full, y, cv=kf, scoring='roc_auc')
print("Random Forest - CV AUC Scores: ", rf_cv_scores)
print("Random Forest - Average CV AUC Score: ", np.mean(rf_cv_scores))

# Perform cross-validation for XGBoost
xgb_cv_scores = cross_val_score(xgb_model_best, X_train_full, y, cv=kf, scoring='roc_auc')
print("XGBoost - CV AUC Scores: ", xgb_cv_scores)
print("XGBoost - Average CV AUC Score: ", np.mean(xgb_cv_scores))
